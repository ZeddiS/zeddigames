...
<body>
  ...
  <section class="hero">
    ...
    <div class="container hero-content">
      <div class="hero-badge">🎮 Verze 0.1.0 · Zdarma pro Windows</div>
      <h1 class="hero-title">
  ...
  <!-- REGISTER CTA -->
  <section class="section" style="padding: 60px 0; background: linear-gradient(135deg, rgba(255,107,0,.08) 0%, transparent 70%);">
    <div class="container" style="text-align:center">
      <p style="font-size:13px;color:var(--orange);font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:12px">ZeddiGames účet</p>
      <h2 style="font-size:clamp(24px,4vw,36px);font-weight:900;margin-bottom:12px">Připoj se ke komunitě</h2>
      <p style="color:var(--text-muted);font-size:16px;max-width:500px;margin:0 auto 28px">Zaregistruj se zdarma — získáš online profil, sledování herního času a přístup z jakéhokoli zařízení.</p>
  ...
  <footer class="footer">
    <div class="container footer-inner">
      ...
      <div class="footer-links">
        <a href="/games/changelog.php">Co je nového</a>
        <a href="/games/register.php">Registrace</a>
        <a href="https://github.com/ZeddiS/zeddigames" target="_blank">GitHub</a>
        <a href="https://zeddihub.eu" target="_blank">ZeddiHub</a>
        <a href="/games/admin/" class="admin-link" style="opacity:.4;font-size:12px">Admin</a>
      </div>
      <p class="footer-copy">© <?= date('Y') ?> ZeddiGames · Součást <a href="https://zeddihub.eu" target="_blank" style="color:var(--orange);text-decoration:none">ZeddiHub</a> ekosystému</p>
    </div>
  </footer>
